...
import { addRequest, updateRequest, loadSampleData as loadRequests } from "../../store/repairRequestsSlice";
...
export default function RepairRequests() {
  ...
  const [filters, setFilters] = useState({ department: "All", status: "All", technicianId: "All" });
    ...
    <div className="bg-gray-100 min-h-screen p-6 space-y-6">
      <div className="flex justify-between items-center">
        ...
        <div className="space-x-3">
          ...
          {!showTrash && (
            <button onClick={handleAddRequest} className="bg-blue-600 text-white px-4 py-2 rounded">
              + Add Request
            </button>
          )}
        </div>
        ...
        <table className="w-full text-left border-collapse">
          ...
          <tbody className="divide-y divide-gray-100">
            {paginatedRequests.length === 0 && (
              <tr>
                <td colSpan="7" className="p-4 text-center text-gray-500">No repair requests found.</td>
              </tr>
            )}
                ...
                <tr key={r.id} className="hover:bg-gray-50 transition-colors">
                  ...
                  <td className="p-4 text-right">
                    <div className="flex justify-end gap-2">
                      {!showTrash ? (
                        <>
                          <button onClick={() => setSelectedRequest(r)} className="p-1 text-blue-600 hover:bg-blue-50 rounded">Edit</button>
